<template>
  <form class="practice-form" @submit.prevent="handleSubmit">
    ...
    <div class="form-field-title">
      ...
      <input v-model="practiceStore.practice.type" type="text" required />
    </div>
    ...
    <div class="form-field-title">
      ...
      <select v-model="practiceStore.practice.University" required>
        <option
    ...
    <div class="form-field-title">
      ...
      <select v-model="practiceStore.practice.Direction" required>
        <option
    ...
    <div class="form-field-title">
      ...
      <select v-model="practiceStore.practice.Supervisor" required>
        <option
    ...
    <div class="form-field-title">
      ...
      <input
        v-model="practiceStore.practice.Student!.User.email"
        type="email"
        required
      />
    </div>
...
const updateEndDateMin = () => {
  if (
    practiceStore.practice.Deadlines!.end <
    practiceStore.practice.Deadlines!.start
  ) {
    practiceStore.practice.Deadlines!.end =
      practiceStore.practice.Deadlines!.start;
  }
